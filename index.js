...
<h4>📝 <b>Last Update: ${moment().format('MMMM Do YYYY, h:mm:ss a')} UTC</b></h4>
<h4>🎂 <b>Followers: ${data.followers ?? "Error"}</b></h4>
<h4>🍪 <b>Following: ${data.following ?? "Error"}</b></h4>
<h4>📖 <b>Public Repo: ${data.public_repos ?? "Error"}</b></h4>
